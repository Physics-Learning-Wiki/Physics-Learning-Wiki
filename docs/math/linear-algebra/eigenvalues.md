...
当你绕某个轴自转时，角动量 $\boldsymbol{L} = \mathbf{I}\boldsymbol{\omega}$ 居然不与角速度平行，产生强烈的轴承偏心力矩．**是否存在一组最特殊的「天选坐标轴」，使得矩阵所有非对角项全部为零？** 在理论力学中，这叫 **主惯性轴**；在振动理论中，这叫 **简正坐标**；在量子力学中，这叫 **力学量本征态**！
