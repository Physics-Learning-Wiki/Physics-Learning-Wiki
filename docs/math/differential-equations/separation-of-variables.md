...
为什么连续的偏微分方程 $\dfrac{\partial^2 u}{\partial x^2} = \dfrac{1}{v^2}\dfrac{\partial^2 u}{\partial t^2}$ 会自动筛选出这组分立的离散频率？**分离变量法 (Separation of Variables，又称傅里叶法）** 揭示了这一奇迹背后的全部数学奥秘．
