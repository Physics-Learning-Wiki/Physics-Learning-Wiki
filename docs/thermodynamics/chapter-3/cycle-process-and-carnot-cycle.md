...
$$
\eta_{\text{max}} = 1 - \frac{298}{558} \approx 0.466 = 46.6\%
$$
...
- 建议先读：[热力学第一定律对理想气体的应用](./first-law-ideal-gas.md)（等温、绝热、等体、等压过程的分析）
- 相关背景：[气体的热容 内能和焓](./gas-heat-capacity-internal-energy-enthalpy.md)（热容、内能、焓的概念）
- 读完本页后可以继续阅读：[第四章 热力学第二定律](../chapter-4/index.md)（卡诺定理的严格证明、熵的概念、热力学第二定律的表述）