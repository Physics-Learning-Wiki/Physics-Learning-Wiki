...
3. 在此基础上建立系统、边界、平衡态、状态量和过程量这些宏观语言。
4. 再介绍热力学定律及其物理含义，尤其是过程方向性与可逆性的区别。
5. 之后引入气体动理论和统计物理，把宏观规律与微观图景连接起来。
...
- 从 [液体](./chapter-1/liquid.md) 到 [热力学系统与状态](./system-state.md) 的过渡，应强调“对不同物态有了直观认识后，需要更严格的系统与状态语言来统一描述它们”。
