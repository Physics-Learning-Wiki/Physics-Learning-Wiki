...
如图1-20，当等温线的温度升高时，气液共存线逐渐缩短，说明气、液体积的差别在减小。到 $T_K$ 时，共存线缩成一点 $K$，气液之间不再有突变，转变变为连续过程。$K$ 称为临界点，$T_K$ 称为临界温度。高于临界温度后，不能再用等温压缩把气体液化。
...
??? note "表1-3 原始数据"
    ...
      34 126   0.12 63   
      74 304   5.10 216   
      221 647   0.006 273.16   
      50 155   9.0015 54   
      13 33   0.072 14   

这组数据对应图1-23中的若干临界点和三相点示例。
