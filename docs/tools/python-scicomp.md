...
| 名称 | 作用 | 官方文档或主页 |
| --- | --- | --- |
| Python | 语言本体与标准库。 | [https://docs.python.org/3/](https://docs.python.org/3/) |
| NumPy | 数组和基础数值计算。 | [https://numpy.org/doc/](https://numpy.org/doc/) |
| SciPy | 科学计算算法库。 | [https://docs.scipy.org/doc/scipy/](https://docs.scipy.org/doc/scipy/) |
| Matplotlib | 科学绘图。 | [https://matplotlib.org/stable/](https://matplotlib.org/stable/) |
| SymPy | 符号计算。 | [https://docs.sympy.org/](https://docs.sympy.org/) |
| pandas | 表格数据处理。 | [https://pandas.pydata.org/docs/](https://pandas.pydata.org/docs/) |
| Jupyter | 交互式笔记本。 | [https://jupyter.org/](https://jupyter.org/) |
| uncertainties | 不确定度传播。 | [https://uncertainties.readthedocs.io/](https://uncertainties.readthedocs.io/) |
| Pint | 单位管理。 | [https://pint.readthedocs.io/](https://pint.readthedocs.io/) |
| Miniforge | conda 生态轻量入口。 | [https://github.com/conda-forge/miniforge](https://github.com/conda-forge/miniforge) |
