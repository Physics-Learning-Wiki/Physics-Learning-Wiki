...
如果你最终文档是 LaTeX，而且非常在意字体、符号和图表与正文的统一风格，PGFPlots 值得学习．它的优点是与 [LaTeX 物理写作](./latex/index.md) 高度一致，缺点是学习曲线相对陡峭，绘制复杂图像时编译也可能更慢．
...
6.  最后再把图插入 [LaTeX 物理写作](./latex/index.md) 文档或实验报告里．
