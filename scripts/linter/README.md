> This part is brought from OI-wiki's linter patch system, which is licensed under (I do not really know actually...). The original code can be found at [here](https://github.com/OI-wiki/OI-wiki/tree/master/scripts/linter)
